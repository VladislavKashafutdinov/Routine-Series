...
export const UnissuedRewardBanner = memo(function UnissuedRewardBanner({ entry, onIssue }: Props) {
  const { t } = useLocale();
  return (
    <div className="ureward-banner">
      ...
      <button className="ureward-banner__btn" onClick={() => onIssue(entry)} type="button">
