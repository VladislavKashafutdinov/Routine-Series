...
### Основная страница для выполнения активностей
...
- Отметка выполнения активности в текущую дату (в том числе при использовании виртуального сегодня, см. "Перемотка времени")
- Отмена отметки выполнения в в текущую дату (в том числе при использовании виртуального сегодня, см. "Перемотка времени")

### Отдельная страница для мониторинга серий
